...
$query3 = mysqli_query($koneksi,"SELECT count(id_peminjaman)AS jumlah_peminjaman FROM peminjaman WHERE id_memberFK='".$_SESSION['id_member']."'");
$query4 = mysqli_query($koneksi,"SELECT count(id_peminjaman)AS jumlah_pengembalian FROM peminjaman WHERE id_memberFK='".$_SESSION['id_member']."' AND status='Dikembalikan'");
